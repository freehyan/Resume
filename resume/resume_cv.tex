...
\geometry{left=2cm, top=0.5cm, right=2cm, bottom=1.5cm, footskip=.5cm} % Configure page margins with geometry
...
\name{余 }{瀚游}
\address{610225,视觉合成图形图像技术国防重点学科实验室,  四川大学}
\mobile{(+86) 18200275893}

\email{freehyan@gmail.com}
\homepage{http://freehyan.me}
\github{freehyan}
%\linkedin{Hanyou Yu}
%\skype{skypeid}
...
\position{Software Engineer{\enskip\cdotp\enskip}Graphics Programmer} % Your expertise/fields
%\quote{``Make the change that you want to see in the world."} % A quote or statement

\makecvfooter{}{Hanyou Yu~~~·~~~Résumé}{} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
